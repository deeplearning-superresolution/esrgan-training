...
parser.add_argument('--image_size', type=int, default=128, help='the dimensions of the hr image to network')
...
parser.add_argument('--checkpoint_dir', default='checkpoints', help="path to the saved models (to continue training)")
